-- =====================================================================
-- RECARGA DOS DADOS DE DEMONSTRAÇÃO — Associação Médica de Imperatriz
--
-- Apaga e recoloca os 24 profissionais fictícios. Use quando a
-- distribuição de demonstração mudar.
--
-- ⚠️  NUNCA rode isto depois que o cadastro real dos associados estiver
--     carregado: a primeira instrução é um TRUNCATE e apaga tudo.
--     Da carga real em diante, quem manda é o importador de planilha.
-- =====================================================================
...
truncate horario, atendimento, local_acessibilidade, local,
  formacao, profissional_especialidade, diretoria, profissional, estabelecimento,
