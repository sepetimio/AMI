...
export function Placa({
  ...
  return (
    <span
      ...
      className="flex shrink-0 items-center justify-center rounded-controle bg-ami-green-800 font-titulo font-bold text-ami-lima-400 shadow-[inset_0_1px_0_rgba(168,212,112,0.22)]"
    >
      {iniciais(nome)}
    </span>
  );
